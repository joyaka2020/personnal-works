...
";
    ...
    {
        return array (  135 => 38,  129 => 25,  120 => 19,  115 => 16,  107 => 13,  104 => 12,  102 => 11,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes déjà connecté entant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/Applications/MAMP/htdocs/SYMPHONY/myBC/myBC/templates/security/login.html.twig");
    }
}
