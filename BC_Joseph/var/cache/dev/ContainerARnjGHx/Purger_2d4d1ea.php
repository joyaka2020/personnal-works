...
class Purger_2d4d1ea extends \Fidry\AliceDataFixtures\Bridge\Doctrine\Purger\Purger implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerbad0f && ($this->initializerbad0f->__invoke($valueHolder674d0, $this, 'create', array('mode' => $mode, 'purger' => $purger), $this->initializerbad0f) || 1) && $this->valueHolder674d0 = $valueHolder674d0;

        return $this->valueHolder674d0->create($mode, $purger);
    }

    public function purge()
    {
        $this->initializerbad0f && ($this->initializerbad0f->__invoke($valueHolder674d0, $this, 'purge', array(), $this->initializerbad0f) || 1) && $this->valueHolder674d0 = $valueHolder674d0;

        return $this->valueHolder674d0->purge();
    }
    ...
    public function __construct(\Doctrine\Persistence\ObjectManager $manager, ?\Fidry\AliceDataFixtures\Persistence\PurgeMode $purgeMode = null)
    {
        ...
        $this->valueHolder674d0->__construct($manager, $purgeMode);
    }
